...
- Media annuale $NO_2$ ottenuta tramite overlay geografico tra disegno delle sezioni censuarie ed il grigliato regolare di output del modello euleriano di dispersione atmosferica CAMx con una risoluzione orizzontale di 4 km. 


- Differenziale di esposizione tra valore di concentrazione ambientale $NO_2$ al 2025 in ciascuna
sezione censuaria ed il controfattuale 10 $\mu g~m^{-3}$ (OMS): media 5.7 $\mu g~m^{-3}$, mediana  5.9 $\mu g~m^{-3}$, range interquartile 3.9 $\mu g~m^{-3}$.
...
- media pesata popolazione 30+: circa 16 $\mu g~m^{-3}$
...
-  media pesata popolazione 30+: 7 $\mu g~m^{-3}$ (Belluno), 18 $\mu g~m^{-3}$ (Padova e Venezia).
:::
...
- *incertezza temporale*: estrazione con reinserimento del valore medio annuale di NO2 per la serie storica 2019-2025
