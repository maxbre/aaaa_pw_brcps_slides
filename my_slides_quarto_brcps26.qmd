...
# Disegno dello studio e fonti informative 
...
$$
AC_i=E_i\cdot\left(1-e^{-\beta\Delta C_i}\right)
$$
...
- Delta esposizione tra concentrazione ambientale $NO_2$ al 2025 e controfattuale 10 $\mu g~m^{-3}$ (OMS): media 5.7 $\mu g~m^{-3}$, mediana  5.9 $\mu g~m^{-3}$, range interquartile 3.9 $\mu g~m^{-3}$.
