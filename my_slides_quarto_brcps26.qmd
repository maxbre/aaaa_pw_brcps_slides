...
[**Quanti casi di decesso per cause respiratorie sono potenzialmente evitabili se<br> l'esposizione annuale a $NO_2$ atmosferico viene ricondotta al livello guida OMS?**]{.highlight .big}
...
- Sezione censuaria come unità di analisi della popolazione a granularità spaziale più fine (normativa privacy dati sanitari individuali).

- Funzione concentrazione-risposta applicata a ogni sezione prima dell'aggregazione regionale.

- Impiego dei dei tassi grezzi provinciali è un'approssimazione esplicita (tassi età-specifici non disponibili).


---

# Dal controfattuale sezione alla stima regionale
...
- serie storica di sette anni e caratterizzata da un trend
