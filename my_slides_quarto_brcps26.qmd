...
- superficie totale: 14 511 km2
- mediana sezione: 2.90 ha
...
- Delta esposizione $NO_2$: media 5.7 $\mu g~m^{-3}$, mediana  5.9 $\mu g~m^{-3}$, range interquartile 3.9 $\mu g~m^{-3}$.
...
-  media pesata Provincia: BL = 7 $\mu g~m^{-3}$, PD e VE = 18 $\mu g~m^{-3}$
...
[*$AC$ = 109.0 casi/anno per cause respiratorie nella popolazione età 30+ ($AF$ = 2.86%)*]{.highlight}
...
[IC 95% propaga esclusivamente l'incertezza epidemiologica del $RR$]{.highlight}
...
- selezione anno 2019 - 2025, campo spaziale applicato a tutte le sezioni, 
estratto un valore $RR$, popolazione e tassi basali fissi

*Risultato:*

- mediana: 145,8 casi/anno, intervallo 95%: 81,5 – 230,5, valore centrale **+34%** rispetto al 2025

::: {.testo-centrato}

[Descrive la sensibilità dei risultati agli scenari storici impiegati (anno esposizione)]{.highlight}
...
Padova e Venezia con i valori assoluti più elevati, 
Belluno più bassi
...
- Scenario 2025 relativamente favorevole rispetto a gran parte del periodo 2019–2025
...
L'esposizione a $\mathrm{NO}_2$ eccedente il livello controfattuale di riferimento è associata ad un carico non trascurabile di mortalità respiratoria nella popolazione 30+ del Veneto.
...
- Disallineamento temporale: popolazione 2021, mortalità 2024, esposizione 2025
...
L'estensione della propagazione dell'incertezza, l'adozione di modelli spaziali e spazio-temporali e l'integrazione di metodi di inferenza causale renderebbero la valutazione più solida e più adatta al supporto quantitativo delle politiche regionali di prevenzione ambientale e sanitaria.
...
- **Modelli spaziali e spazio-temporali**
  - Stima stabilizzata della mortalità nelle piccole aree mediante Empirical Bayes
  - Modelli gerarchici bayesiani per la dipendenza spaziale, con inferenza tramite INLA
...
**Obiettivo operativo:** estendere la VIS da analisi descrittiva a strumento più robusto di supporto alle politiche regionali.
...
- Sezione censuaria:  unità di analisi della popolazione a granularità spaziale più fine (limite normativa privacy dati sanitari individuali).

- Funzione concentrazione-risposta: applicata a ogni sezione prima dell'aggregazione regionale.

- Tassi grezzi provinciali: è un'approssimazione esplicita dei dati (tassi età-specifici non disponibili).
...
- mancato aggiustamento della struttura per età
- incertezza popolazione, tassi ed esposizione non propagata
- IC simulazione 2025 rappresenta l'incertezza del $RR$, non l'incertezza complessiva VIS
...
downscaling modellistica qualità aria
