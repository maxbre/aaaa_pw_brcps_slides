...
- Tassi grezzi provincial: è un'approssimazione esplicita dei dati (tassi età-specifici non disponibili).
...
- campo spaziale concentrazione applicato a tutte le sezioni
...
[Descrive la sensibilità dei risultati agli scenari storici impiegati (anno di esposizione): non è un IC della stima 2025 e non è una previsione futura]{.highlight}
...
L'esposizione a $\mathrm{NO}_2$ eccedente il livello controfattuale di riferimento è associata a un carico non trascurabile di mortalità respiratoria nella popolazione adulta del Veneto.
