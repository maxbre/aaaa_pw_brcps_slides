...
Per Regione: concentrazione media  $NO_2$ pesata sulla popolazione 30+, circa 16 $\mu g~m^{-3}$.<br> Per Provincia: concentrazione media tra 7 $\mu g~m^{-3}$ (Belluno) e 18 $\mu g~m^{-3}$ (Padova e Venezia).
